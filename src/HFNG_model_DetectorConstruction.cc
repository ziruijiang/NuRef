...
{  
  ...
  G4VSolid * inside_block =
	  new G4Box("Inside Block",
		  26.046*mm, 64.146*mm, 80.01*mm); //the walls are actually thinner; set x to 31.115*mm, but 26.046 matches the shape of the inside cylinders
  G4ThreeVector pos_inside_block(0, 0, -3.81*mm);

  //Side Rectangle
  G4VSolid* side_rect =
	  new G4Box("Side Rectangle",
		  3.175*mm, 6.*mm, 31.75*mm);
  ...
  G4ThreeVector pos_top_cyl1(9.017*mm, -70.358*mm, 57.785*mm);
  G4ThreeVector pos_top_cyl2(0, -36.5*mm, 57.785*mm);
  G4ThreeVector pos_top_cyl3(0, 36.5*mm, 57.785*mm);
  G4ThreeVector pos_top_cyl4(-9.017*mm, 70.369*mm, 57.785*mm);
